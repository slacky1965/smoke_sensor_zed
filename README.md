...
* Подключиться к сети zigbee - нажать кнопку 3 раза (подтверждение включение зеленого светодиода на 1.5 секунды).
* Покинуть сеть zigbee - нажать кнопку 3 раза (подтверждение включение зеленого светодиода на 1.5 секунды).
