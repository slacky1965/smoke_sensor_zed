...
* Базовые кластеры.
* Кластер IAS, который собственно и сообщает о дыме, снятии устройства с крепежной пластины и разряженной батареи.
* Кластер OnOff, который посылает команду при обнаружении дыма на выбранное заранее устройство (прямой биндинг).
* Кластер OnOffCfg, который позволяет выбрать действие кластера OnOff. Т.е. при обнаружении дыма возможно три варианта команды - On-Off, Off-On или Toggle.
